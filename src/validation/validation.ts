...
const createKycSchema = object({
    validationNumber: string().min(9, "Validation number can't be less than 9 digits").max(16, "Validation number can't be more than 16 digits").required("Validation number is requried"),
